...
def backpropagate(variable: Variable, deriv: Any) -> None:
    ...
    for var in ordered_vars:
        if var.is_leaf():
            var.accumulate_derivative(derivatives[var.unique_id]) # Only leaf variables can have derivatives, so accumulate derivative for leaf variables in many iterations
        else:
